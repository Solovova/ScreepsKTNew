...
var role_A_Filler = {
	run: function(creep) {
	    ...
	    //если жить осталось меньше 100 то переводим роль чтоб уже начал делатся новый
        if ((creep.memory.role <1000) & (creep.ticksToLive < 200 )){
